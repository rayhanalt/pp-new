...
@section('content')
    <div class="overflow-x-auto">
        <div class="card shadow-xl">
            <h3 class="sticky top-0 text-lg font-bold">Tambah Data Proyek
                <hr>
            </h3>
            <div class="card-body">
                <form action="/proyek" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-control w-full max-w-full">
                        ...
                        <input name="nama_proyek" type="text" placeholder="Type here" value="{{ old('nama_proyek') }}"
                    ...
                    <div class="form-control w-full max-w-full">
                        ...
                        <input name="tgl_mulai" type="date" placeholder="Type here" value="{{ old('tgl_mulai') }}"
                    ...
                    <div class="form-control w-full max-w-full">
                        ...
                        <input name="tgl_selesai" type="date" placeholder="Type here" value="{{ old('tgl_selesai') }}"
                            class="datepicker input-bordered input w-full max-w-full" />
                        <label class="label">
                            <span class="label-text-alt"></span>
                            <span class="label-text-alt text-red-600">
                    ...
                    <div class="form-control w-full max-w-full">
                        ...
                        <input name="tgl_dibuat" type="date" placeholder="Type here" value="{{ old('tgl_dibuat') }}"
                            class="datepicker input-bordered input w-full max-w-full" />
                        <label class="label">
                            <span class="label-text-alt"></span>
                            <span class="label-text-alt text-red-600">
                    ...
                    <div class="form-control w-full max-w-full">
                        ...
                        <input name="nama_mitra" type="text" placeholder="Type here" value="{{ old('nama_mitra') }}"
                            class="input-bordered input w-full max-w-full" />
                        <label class="label">
                            <span class="label-text-alt"></span>
                            <span class="label-text-alt text-red-600">
